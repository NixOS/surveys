    ...
    page = Page(
        ...
        sections=[
            Section(
                "people",
                "People",
                note="Categories with fewer than 5 respondents are not shown.",
                rows=[
                    Row(
                        "country",
                        "Country",
                        question=q("country"),
                        commentary=cm["country"],
                        charts=[
                            horizontal_bar(
                                counts_single(
                                    r.country, bucket_min_percent=None, bucket_action="drop"
                                )
                            )
                        ],
                    ),
                    ...
                    Row(
                        ...
                        question=q("transgender"),
                        commentary=cm["transgender"],
                        charts=[
                            horizontal_bar(
                                counts_single(
                                    r.transgender, bucket_min_percent=None, bucket_action="drop"
                                )
                            )
                        ],
                    ),
                    ...
                    Row(
                        ...
                        charts=[
                            lollipop(
                                counts_single(r.role, bucket_min_percent=None, bucket_action="drop")
                            )
                        ],
                    ),
                    Row(
                        ...
                        "Industry",
                        question=q("industry"),
                        commentary=cm["industry"],
                        charts=[
                            lollipop(
                                counts_single(
                                    r.industry, bucket_min_percent=None, bucket_action="drop"
                                )
                            )
                        ],
                    ),
                    Row(
                        ...
                        "Domain",
                        question=q("domain"),
                        commentary=cm["domain"],
                        charts=[
                            lollipop(
                                counts_single(
                                    r.domain, bucket_min_percent=None, bucket_action="drop"
                                )
                            )
                        ],
                    ),
            ...
            Section(
                ...
                rows=[
                    ...
                    Row(
                        "infrastructure",
                        "Infrastructure",
                        question=q("infrastructure"),
                        commentary=cm["infrastructure"],
            ...
            Section(
                ...
                rows=[
                    Row(
                        ...
                        charts=[
                            ...
                            sankey(
                                su_cross_nodes,
                                su_cross_links,
                                title="Upgrade outcome by experience",
                            ),
                        ],
                    ),
                    Row(
                        "involvement",
                        "Involvement",
                        question=q("involvement"),
                        commentary=cm["involvement"],
                    ...
                    Row(
                        ...
                        question=q("traits"),
                        commentary=cm["traits"],
                        charts=[horizontal_bar(counts_multi(r.traits))],
                    ),
                    Row(
                        "improvements",
                        "Wished-for improvements",
                        question=q("improvements"),
                        commentary=cm["improvements"],
                    ...
                    Row(
                        ...
                        charts=[
                            heatmap(
                                _skill_x_exp_ct, annotate=True, height=356, title="Distribution"
                            ),
                    ...
                    Row(
                        ...
                        charts=[
                            heatmap(
                                _traits_rate_exp_ct, annotate=True, height=540, vm_min=0, vm_max=100
                            ),
                        ],
                    ),
                    Row(
