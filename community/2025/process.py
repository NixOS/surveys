        ...
        sections=[
            Section("people", "People", rows=[
                Row("country", "Country", commentary=cm["country"],
                    chart=horizontal_bar(counts_single(r.country, bucket_min_percent=None))),
                ...
                Row("gender_identity", "Gender Identity", commentary=cm["gender_identity"],
                    chart=horizontal_bar(counts_single(r.gender_identity, bucket_min_percent=None))),
                Row("transgender", "Transgender Identity", commentary=cm["transgender"],
                    chart=horizontal_bar(counts_single(r.transgender, bucket_min_percent=None))),
                ...
                Row("role", "Role", commentary=cm["role"],
                    chart=horizontal_bar(counts_single(r.role, bucket_min_percent=None))),
                Row("industry", "Industry", commentary=cm["industry"],
                    chart=horizontal_bar(counts_single(r.industry, bucket_min_percent=None))),
                Row("domain", "Domain", commentary=cm["domain"],
                    chart=horizontal_bar(counts_single(r.domain, bucket_min_percent=None))),
            ]),
